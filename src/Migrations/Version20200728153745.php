 ...
 */
final class Version20200728153745 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advertisement CHANGE association_id association_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advertisement CHANGE association_id association_id INT DEFAULT NULL');
