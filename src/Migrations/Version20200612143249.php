 ...
 */
final class Version20200612143249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE member CHANGE profile profile JSON DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE updated_by_id updated_by_id INT DEFAULT NULL, CHANGE validated_by_id validated_by_id INT DEFAULT NULL, CHANGE data_usage_agreement data_usage_agreement TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE mobile mobile VARCHAR(20) DEFAULT NULL, CHANGE validated_at validated_at DATETIME DEFAULT NULL, CHANGE sex sex VARCHAR(10) DEFAULT NULL, CHANGE dob dob DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE member CHANGE profile profile LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\'');
        $this->addSql('ALTER TABLE networks_social_link CHANGE association_id association_id INT DEFAULT NULL');
