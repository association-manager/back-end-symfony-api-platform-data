...
final class Version20200531153755 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE announce ADD CONSTRAINT FK_E6D6DD75C1D6EFD5 FOREIGN KEY (file_manager_id) REFERENCES file_manager (id)');
        $this->addSql('CREATE INDEX IDX_E6D6DD75C1D6EFD5 ON announce (file_manager_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE announce DROP FOREIGN KEY FK_E6D6DD75C1D6EFD5');
        ...
        $this->addSql('DROP INDEX IDX_E6D6DD75C1D6EFD5 ON announce');
